      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-light-text dark:text-dark-text mb-2">주소</h4>
                    <p className="text-light-text/80 dark:text-dark-text/80">
                      서울특별시 중구 을지로 100<br />
                      Harbor & Voyage Building 1F
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-light-text dark:text-dark-text mb-2">운영시간</h4>
                    <div className="space-y-1 text-light-text/80 dark:text-dark-text/80">
                      <p><span className="font-medium">카페 (Day Mode)</span> : 06:00 - 18:00</p>
                      <p><span className="font-medium">펍 (Night Mode)</span> : 18:00 - 02:00</p>
                      <p className="text-sm text-light-primary dark:text-dark-primary">연중무휴</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-light-text dark:text-dark-text mb-2">연락처</h4>
                    <p className="text-light-text/80 dark:text-dark-text/80">
                      02-1234-5678
                    </p>
                  </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-light-text dark:text-dark-text mb-2">이메일</h4>
                    <p className="text-light-text/80 dark:text-dark-text/80">
                      hello@harborvoyage.kr
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            {/* Map Placeholder */}
            <div className="aspect-square rounded-xl bg-gradient-to-br from-light-secondary to-light-primary dark:from-dark-secondary dark:to-dark-primary flex items-center justify-center">
              <div className="text-center text-white">
                <div className="text-6xl mb-4">🗺️</div>
                <h4 className="font-serif text-xl font-semibold mb-2">카카오맵 연동</h4>
                <p className="text-sm opacity-90">
                  정확한 위치와 경로를 확인하세요
                </p>
                <button className="mt-4 px-6 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-medium hover:bg-white/30 transition-colors">
                  지도에서 보기
                </button>
              </div>
            </div>
            ...
            <div className="mt-6 space-y-3">
              <h4 className="font-semibold text-light-text dark:text-dark-text">교통편</h4>
              <div className="space-y-2 text-sm text-light-text/80 dark:text-dark-text/80">
                <p><span className="font-medium text-light-primary dark:text-dark-primary">지하철</span> : 2호선 을지로입구역 3번 출구 (도보 5분)</p>
                <p><span className="font-medium text-light-primary dark:text-dark-primary">버스</span> : 100, 150, 201, 202번 (을지로 정류장)</p>
                <p><span className="font-medium text-light-primary dark:text-dark-primary">주차</span> : 건물 지하 주차장 이용 가능 (2시간 무료)</p>
              </div>
            </div>
          </motion.div>
        </div>
