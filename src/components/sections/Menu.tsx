...
const Menu = () => {
  ...
  const dayMenu = [
    {
      category: '브런치',
      items: [
        { name: '항구 풀브렉퍼스트', description: '바다의 풍미를 담은 완벽한 아침', price: '18,000' },
        { name: '선원의 팬케이크', description: '메이플 시럽과 베리가 올라간 푸짐한 팬케이크', price: '14,000' },
        { name: '부두 샌드위치', description: '신선한 야채와 훈제연어를 올린 건강한 샌드위치', price: '16,000' },
      ]
    },
    {
      category: '커피 & 음료',
      items: [
        { name: '하버 라떼', description: '부드럽고 깊은 맛의 시그니처 라떼', price: '6,500' },
        { name: '컴퍼스 드립', description: '매일 로스팅하는 원두로 내린 핸드드립', price: '5,500' },
        { name: '바다 브리즈 에이드', description: '상큼한 레몬과 민트의 만남', price: '7,000' },
      ]
    }
  ]
  ...
  const nightMenu = [
    {
      category: '칵테일',
      items: [
        { name: '캡틴스 럼', description: '카리브해의 정통 럼에 라임과 민트를 더한 시그니처', price: '14,000' },
        { name: '문라이트 진토닉', description: '달빛처럼 청량한 프리미엄 진토닉', price: '12,000' },
        { name: '항해자의 위스키', description: '숙성된 위스키에 허브와 스파이스의 조화', price: '16,000' },
      ]
    },
    {
      category: '안주 & 디너',
      items: [
        { name: '바다의 플래터', description: '신선한 해산물과 치즈의 조합', price: '28,000' },
        { name: '선원의 스테이크', description: '부드러운 등심에 특제 소스', price: '32,000' },
        { name: '항구 파스타', description: '해산물이 듬뿍 들어간 토마토 파스타', price: '18,000' },
      ]
    }
  ]
  ...
  return (
    <section id="menu" className="py-20 px-4 bg-light-bg-secondary/30 dark:bg-dark-bg-secondary/30">
